...
int logging(player&p)
{
	...
	cout<<"\nShield : "<<p.s.name; display_shieldstats(p.s); cout<<endl;
...
int shop(player&p)
{
	...
	while(check == 1)
	{
		...
		cout<<"\n1. Improve Weapon (Improves Damage by 25 percent) : 300 Coins"<<endl;
		cout<<"\n2. Streamline Weapon (Decreases weight by 1) : 100 Coins"<<endl;
		cout<<"\n3. Improve Armor (Improves Defence by 25 percent) : 300 Coins"<<endl;
		cout<<"\n4. Buy Healing Potions (5) : 300 Coins"<<endl;
		cout<<"\n5. Buy Lucky Charm (Luck increases by 2) : 100 Coins"<<endl;
		cout<<"\n6. Exit"<<endl;
