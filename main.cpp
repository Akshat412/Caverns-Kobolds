		...
		switch(p.level)
		{
			...
			case 1:
			{
				...
				switch(classchoice)
				{
					case 1:
					{
						cout<<"\nBlacksmith : Alright, lemme go fetch that mace for ye..."<<endl;
						cout<<"\nAs Berserker, you can take a lot of damage. Also, you use the most powerful weapons in the game. However, your accuracy is very poor and you don't know any magic"<<endl;
					}
					break;
					
					case 2:
					{
						cout<<"\nBlacksmith : Like those healing spells?"<<endl;
						cout<<"\nAs Herald, you have a better healing spell than other combat oriented classes. Use it to your advantage in combat"<<endl;
					}
					break;
					
					case 3:
					{
						cout<<"\nBlacksmith : Good with a sword, aren't ya?"<<endl;
						cout<<"\nAs Knight, you have the highest weapon handling. Your attacks will almost certainly land"<<endl;
					}
					break;
					
					case 4:
					{
						cout<<"\nBlacksmith : Packing light?"<<endl;
						cout<<"\nAs Rogue, you are incredibly weak in combat. However, a high luck, quickness in combat and the ability to sneak up on enemies will help you not get killed instantly"<<endl;
					}
					break;
					
					case 5:
					{
						cout<<"\nBlacksmith : I have some books on magic here...read up"<<endl;
						cout<<"\nAs Pyromancer, you can barely attack and dodge. But, you have the ability to use high level magic spells. Use your fireball during combat to incinerate enemies"<<endl;
					}
					break;
				}
				...
				cout<<"\nBlacksmith : Here, take these "<<p.no_hp<<" Healing Potions, and these 5 Ales."<<endl;
